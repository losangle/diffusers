...
def main(args):
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        train_loss = 0.0
        for step, batch in enumerate(train_dataloader): # Batch['pixel_values'] has shape of (batch_sz=1,3,resolution=512,resolution=512)
            with accelerator.accumulate(unet):
                ...
                model_input = vae.encode(pixel_values).latent_dist.sample() # model_input has shape (batch_sz,4,64,64)
